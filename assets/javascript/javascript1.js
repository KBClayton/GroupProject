$(document).ready(function(){
    ...
    $("#submitBtn").on("click", function(){
        ...
        var queryURLBasic =   ("https://en.wikipedia.org/w/api.php?action=query&titles="+ userSearch +"&prop=extract&exlimit=n&rvprop=content&format=json&formatversion=2");
        var queryURL =      ("https://en.wikipedia.org/w/api.php?format=json&titles=" + userSearch + "&action=query&prop=extracts&exsectionformat=plain&exintro=&explaintext=&");
